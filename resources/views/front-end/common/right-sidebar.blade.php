    ...
    <div class="slimscrollright">
        ...
        <div class="r-panel-body">
            <ul class="m-t-20 chatonline">
                ...
                <li>
                    <a href="javascript:void(0)"><img src="{!! url('public/home/') !!}/plugins/images/users/genu.jpg" alt="user-img" class="img-circle"> <span>Genelia Deshmukh <small class="text-warning">Away</small></span></a>
                </li>
                <li>
