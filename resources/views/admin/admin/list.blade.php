                                    ...
                                    <td>
                                        <div class="checkbox">
                                            ...
                                            @else
                                                <?php $status = '' ?>
                                            @endif
                                            <input type="checkbox" data-size="small" value="1" data-type="status" data-src="{!! route('admin.adm.postUpdateItem') !!}" name="status" {{ $status }}  class="js-switch updateItem" data-id="{!! $item->id !!}" data-color="#99d683"> Hiển thị
                                        </div>
                                    </td>
                                    <td>
                                        <a href="{!! url('admin/adm/edit/') !!}/{!! $item->id !!}" id="editItem"><i class="ti-pencil text-success"></i></a>
                                        <a href="javascript:void(0)" class="delItem" data-id="{!! $item->id !!}" data-link="{!! url('admin/adm/delItem') !!}" data-msg="Bạn muốn xóa?"><i class="ti-trash text-danger"></i></a>
                                    </td>
                                </tr>
                                <?php $i++?>
                            @endforeach
