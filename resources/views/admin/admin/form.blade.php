            ...
            <div class="col-sm-7">
                <div class="white-box">
                    ...
                    @if(isset($detail) && $detail->id)
                            <a style="font-size: 15px" href="{!! route('admin.adm.getAdd') !!}" class="text-success"> <i  class="fa fa-plus-circle text-success" aria-hidden="true"></i> Thêm mới</a>
                    @endif
                        <a style="font-size: 15px" href="{!! route('admin.adm.getList') !!}" class="text-success"> <i class="fa fa-list-ul text-success" aria-hidden="true"></i> Danh sách</a>
                    </p>
