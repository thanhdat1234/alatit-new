                        ...
                        @if($data)
                            ...
                            @foreach($data as $item)
                                <tr id="{!! $item->id !!}">
                                    ...
                                    <td>#{!! $item->id !!}</td>
                                    <td>{!! $item->name !!}</td>
                                    <td><img src="{!! url('resources/upload/post/') !!}/{!! $item->avatar !!}" alt="" width="60"></td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="checkbox">
                                            ...
                                            @else
                                                <?php $status = '' ?>
                                            @endif
                                            <input type="checkbox" data-size="small" value="1" data-type="status" data-src="{!! route('admin.pst.postUpdateItem') !!}" name="status" {{ $status }}  class="js-switch updateItem" data-id="{!! $item->id !!}" data-color="#99d683"> Hiển thị
                                        </div>
                                        ...
                                        <div class="checkbox">
                                            ...
                                            @else
                                                <?php $home = '' ?>
                                            @endif
                                            <input type="checkbox" data-size="small" data-type="home" data-src="{!! route('admin.pst.postUpdateItem') !!}" value="1" name="home" {{ $home }}  class="js-switch updateItem" data-id="{!! $item->id !!}" data-color="#99d683"/> Trang chủ
                                        </div>
                                        <div class="checkbox">
                                            @if(isset($item) && $item->new == 1)
                                                <?php $new = 'checked' ?>
                                            @else
                                                <?php $new = '' ?>
                                            @endif
                                            <input type="checkbox" data-size="small" data-type="new" data-src="{!! route('admin.pst.postUpdateItem') !!}" value="1" name="hot" {{ $new }}  class="js-switch updateItem" data-id="{!! $item->id !!}" data-color="#99d683"/>Tin mới
                                        </div>

                                    </td>
                                    <td>
                                        <a href="{!! url('admin/pst/edit/') !!}/{!! $item->id !!}" id="editItem"><i class="ti-pencil text-success"></i></a>
                                        <a href="javascript:void(0)" class="delItem" data-id="{!! $item->id !!}" data-link="{!! url('admin/pst/delItem') !!}" data-msg="Bạn muốn xóa?"><i class="ti-trash text-danger"></i></a>
                                    </td>
                                </tr>
                                <?php $i++?>
                            @endforeach
