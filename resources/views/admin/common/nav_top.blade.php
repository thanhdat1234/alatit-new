    ...
    <div class="navbar-header">
        ...
        <div class="top-left-part">
            <a class="logo" href="{!! url('admin') !!}">
                <b>
                    <img src="{!! url('public/logo') !!}/logo.png" alt="ariweb" class="dark-logo" width="100px"/>
                </b>
            </a>
        </div>
        ...
        <ul class="nav navbar-top-links navbar-right pull-right">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu mailbox animated bounceInDown">
                    ...
                    <li><a class="text-center" href="javascript:void(0);"> <strong>See all notifications</strong> <i
                            ...
                            <div>
                                ...
                                <div class="progress progress-striped active">
                                    <div class="progress-bar progress-bar-danger" role="progressbar" aria-valuenow="80"
                                         aria-valuemin="0" aria-valuemax="100" style="width: 80%"><span class="sr-only">80% Complete (danger)</span>
                                    </div>
                                </div>
                            </div>
                        </a></li>
